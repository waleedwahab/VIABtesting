    ...
    <div className="container-fluid  insuranceSection py-4 pb-5">
      <div className="container py-4 px-4 second-layer ">
        ...
        <div className="d-flex flex-wrap gap-2 mb-4">
          <select className="form-select w-auto auto w-sm-100">
            <option className=" w-sm-100">Insurance Type</option>
          </select>
          <select className="form-select w-auto auto w-sm-100">
            <option className=" w-sm-100">Coverage Level</option>
          </select>
          <select className="form-select w-auto w-sm-100">
            <option className=" w-sm-100">Provider</option>
          </select>
          <select className="form-select w-auto auto w-sm-100">
            <option className=" w-sm-100">Price</option>
          </select>
        </div>
